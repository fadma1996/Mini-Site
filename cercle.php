...
<body><br></br>
<h1>Calculant l'aire d'un cercle</h1>
<div class="div1">
<form method="POST">
             π X rayon(
...
<p>Tapez la longueur du rayon pour avoir l'aire du cercle.</p>
<h2>Comment calculer l'aire d'un cercle</h2>
<p>L'aire d'un cercle est égale à son rayon au carré multiplié par π (environ 3,14).<p>
<h3>Aire du cercle = (Rayon)² x π = r².π</h3><img src="images/cercle.png" align="right"><br>
<h4>Exemple 1 :</h4>
<p>Soit un cercle C de rayon r = 2 cm, on utilise π = 3,14<br>
L'aire du cercle C = (2 cm)² x 3,14<br>
L'aire du cercle C = 12,56 cm²</p>
<h4>Exemple 2 :</h4>
<p>Soit un cercle C de diamètre d = 6 cm, on utilise π = 3,14<br>
L'aire du cercle C = (6 cm / 2)² x 3,14 (la longueur du rayon étant la moitié du diamètre)<br>
L'aire du cercle C = 28,26 cm²</p>
<h4>Remarque :</h4>
<p>Le rayon est un segment délimité par le centre et un point du cercle.<br>
<h2>Propriétés du cercle:</h2>
<p>La longueur du rayon est la distance entre le centre du cercle n'importe quel point du cercle.<br>
...
π est le rapport entre le périmètre du cercle qu'on appelle circonférence et son diamètre, sa valeur approximative est égale à 3,14159265358979323846.<br></p>
</form>
</div>
</body>
</html>