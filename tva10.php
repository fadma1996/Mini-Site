...
<body>
<br></br>><h1>Calcule TVA 10%</h1>
<div class="div1">
<form method="POST">
			<h2>Calcul TVA 10% a partir de montant H.T. ou à partir du montant TTC</h2>
             Montant HT 
			<td><input type="text" name="ht" /></td><br>  TVA(10%) <td><input type="text" name="tva" /></td><br> 
...
<p>1 - Indiquez le montant TTC pour calculer le montant HT et la TVA 10% <br>
2 - Indiquez la TVA 10% pour calculer le montant HT et le montant TTC<br> 
3 - Indiquez le montant HT pour calculer le montant TTC et la TVA 10% </p>
<h5>Comment calculer la tva au taux de 10% à partir du montant TTC</h5>
<p>Le montant H.T. est égal au montant TTC divisé par 1,1.<br>
La tva est la différence entre le montant TTC et le montant H.T.</p>
<h3>Montant H.T. = Montant TTC / 1,1<br>

Tva = Montant TTC - Montant H.T.</h3>
<h5>Exemple :</h5>
<p>Calculons le montant H.T. et la tva de 200 euros TTC :<br>
Le montant H.T. = 200 / 1,1 euros = 181,81 euros<br>
La tva = 200 - 181,81 euros = 18,18 euros</p>
</div>
</body>
</html>