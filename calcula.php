...
<label>Selectionnez une opération :</label>
<select name="dropdown">
	
	<option value="Addition">Somme</option>
	<option value="Soustraction">Soustraction</option>
	<option value="Multiplication">Multiplication</option>
	<option value="Division">Division</option><br>
</select><br></br>
Entrer le Premier Nombre : <input type="text" name="pn" required /><br></br>
Entrer le Deuxième Nombre : <input type="text" name="dn" required /><br><br>
...
<p>Entrer le Nombre :</p> <input type="text" name="nbr" required /><br></br>

<input type="submit" value="Entrer" name="send" />
